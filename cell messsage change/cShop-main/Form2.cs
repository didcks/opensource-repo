...
namespace 윈도우프로그래밍_프로젝트
{
    public partial class Form2 : Form
    {
        ...
        private void ceuniversity_SelectedIndexChanged(object sender, EventArgs e)
        {
            string selectedItem = ceuniversity.SelectedItem.ToString();
            if (selectedItem == "1학년")
            {
            ...
            if (selectedItem == "교양")
            {
                cultureGrade.Visible = true;
            }
            else
            {
               cultureGrade.Visible = false;
            }

            string inputItem = ceuniversity.SelectedItem.ToString();
            Random random = new Random();
            Color randomColor = Color.FromArgb(random.Next(256), random.Next(256), random.Next(256));
            ...
            {
                MessageBox.Show("셀이 선택되지 않았습니다."); // 선택된 셀이 없는 경우 메시지 표시
            }
        }
        ...
        private void color_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (selectedColor == "green")
                TimeTable.DefaultCellStyle.BackColor = Color.Green;
            ...
            if (selectedColor == "red")
                TimeTable.DefaultCellStyle.BackColor = Color.Red;
            if (selectedColor == "violet")
                TimeTable.DefaultCellStyle.BackColor = Color.Violet;
            if (selectedColor == "orangered")
                TimeTable.DefaultCellStyle.BackColor = Color.OrangeRed;
        }
        ...
        private void cultureGrade_SelectedIndexChanged(object sender, EventArgs e)
        {
            string inputItem = cultureGrade.SelectedItem.ToString();
            Random random = new Random();
            Color randomColor = Color.FromArgb(random.Next(256), random.Next(256), random.Next(256));
            if (TimeTable.SelectedCells.Count > 0)
            {
        ...
        {
            string selectedItem = ceuniversity.SelectedItem.ToString();
            if (selectedItem == "창의공과대학")
            {
                ceuniversity.Visible = true;
            }
            else
            {
                ceuniversity.Visible = false;
            }
            if (selectedItem == "교학대학")
            {
                ceuniversity.Visible = true;
            }
            else
